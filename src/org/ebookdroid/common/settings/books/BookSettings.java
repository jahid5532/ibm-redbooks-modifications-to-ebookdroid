...
public class BookSettings implements CurrentPageListener {
    ...
    public void currentPageChanged(final PageIndex oldIndex, final PageIndex newIndex) {
    	...
    	//Log.i("Old index  ===>", oldIndex+"-----"+oldIndex.FIRST+"--------"+oldIndex.LAST+"---------"+oldIndex.viewIndex+"<---------------------");
    	//Log.i("New index  ===>", newIndex+"-----"+newIndex.FIRST+"--------"+newIndex.LAST+"---------"+newIndex.viewIndex+"<---------------------");
    	
    	//ViewerActivity.livedraggingslider.setMax(0);
    	//ViewerActivity.livedraggingslider.setMax(ViewerActivityController.maxpagenumberis+1);
    	//ViewerActivity.livedraggingslider.setProgress((newIndex.viewIndex+1));
    	//ViewerActivity.livedraggingslider.callOnClick();
    	//ViewerActivity.livedraggingslider.buildLayer();
    	//ViewerActivity.livedraggingslider.removeOnAttachStateChangeListener(listener)
    	
    	ViewerActivity.livedraggingslider.setMax(0);
    	ViewerActivity.livedraggingslider.setMax(ViewerActivityController.maxpagenumberis+1);
    	if(newIndex.viewIndex>=(ViewerActivityController.maxpagenumberis+1))
    		ViewerActivity.livedraggingslider.setProgress((newIndex.viewIndex));
    	else
    		ViewerActivity.livedraggingslider.setProgress((newIndex.viewIndex+1));

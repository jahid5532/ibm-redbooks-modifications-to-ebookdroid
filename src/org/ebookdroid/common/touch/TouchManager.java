...
public class TouchManager {
    ...
    public static class TouchProfile {
        ...
        public Integer getAction(final Touch type, final float x, final float y, final float width, final float height) {
        	/*
        	 if(ViewerActivity.touchdecisionbox)
         	{
        		 ViewerActivity.onelay.setAlpha(1.0f);
        		 ViewerActivity.onelay.setVisibility(1);
        		 ViewerActivity.touchdecisionbox=false;;
         	}
         	else
         	{
         		ViewerActivity.onelay.setAlpha(0.0f);
         		ViewerActivity.searchControls.setAlpha(0.0f);
         		ViewerActivity.onelay.setVisibility(0);
         		ViewerActivity.touchdecisionbox=true;
         	}
        	*/
            ...
            if("SingleTap".equalsIgnoreCase(type.SingleTap.name()))
            {
                if(ViewerActivity.touchdecisionbox)
                {
                    ViewerActivity.lytContainer.setVisibility(View.VISIBLE);
                ...
                else
                {
                    ...
                    //ViewerActivity.lytContainer.setAlpha(0.0f);
                    ViewerActivity.lytContainer.setVisibility(View.GONE);
                    ViewerActivity.searchControls.setVisibility(View.GONE);
                    ViewerActivity.zoomControls.setVisibility(View.GONE);
                    //ViewerActivity.searchControls.setAlpha(0.0f);
                    //ViewerActivity.onelay.setVisibility(0);
                    ViewerActivity.touchdecisionbox=true;
                }

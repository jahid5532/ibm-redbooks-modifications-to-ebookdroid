...
public class GoToPageDialog extends Dialog {
    ...
    protected void onStart() {
        ...
        llout=(LinearLayout) findViewById(R.id.goToButton);
    ...
    public void removeBookmark(final ActionEx action) {
        ...
        Toast.makeText(getContext(), "Bookmark deleted successfully.",Toast.LENGTH_LONG).show();
    }
    ...
    public void showAddBookmarkDlg(final ActionEx action) {
        ...
        if (bookmark == null) {
            ...
            //Log.i(" bookmark.name is ==============> ",bookmark.name+"<==================");
    ...
    private void updateControls(final int viewIndex, final boolean updateBar) {
        ...
        editText.selectAll();
        //if(((viewIndex + offset)-1)>=1)
        //{
        	//base.jumpToPage(((viewIndex + offset)-1), 0, 0, AppSettings.current().storeGotoHistory);
        //}
        
        //Button dd=(Button) findViewById(R.id.goToButton);
        //ViewerActivity.livedraggingslider.setProgress((viewIndex + offset)-1);

...
public class RecentActivity extends AbstractActionActivity<RecentActivity, RecentActivityController> {
    ...
    public RecentActivityController rdd=null;
    ...
    public void showDocumentNewReader() 
    {
    	//Log.i("Came here =======================> ","camne here");
       ...
       // Log.i("Show document path is =====> ",(Uri.fromFile(file)+""));
        if (!file.isDirectory()) 
        {
           ...
           // base.showDocument(Uri.fromFile(file), null);
        	rdd.showDocument(Uri.fromFile(file), null);
...
//if(0==0) return;
    ...
    protected void onCreateBookMenu(final ContextMenu menu, final BookNode node) {
        ...
        list.add(new Bookmark(true, getString(R.string.bookmark_start), PageIndex.FIRST, 0, 0));//Murali commenting for removing the start and end buttons in showbookmarks
        list.add(new Bookmark(true, getString(R.string.bookmark_end), PageIndex.LAST, 0, 1));//Murali commenting for removing the start and end buttons in showbookmarks
        if (bs != null) {

...
public class OutlineDialog extends Dialog implements OnItemClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        //this.getWindow().setBackgroundDrawableResource(R.style.CustomDialog);
        //this.getWindow().setBackgroundDrawable(R.style.CustomDialog);
        ...
        //listView.setBackgroundResource(R.drawable.rounded_border);
